...
This program is built to manage an array list of students. It reads from a CSV file, and uses that data to populate an array list.
As it reads each student value from the file, a new student object is created. The student object contains methods that will allow
the program to calculate the average student grade, and perform comparisons on each student.
 */
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        //=====ADD MORE STUDENTS=====//
        Student newStudent1 = new Student("67T4","Clouse B",new int[]{80,75,98});
        Student newStudent2 = new Student("45P5","Garrison J",new int[]{75,78,72});
        Student newStudent3 = new Student("98P0","Singer A",new int[]{85,95,99});
        ...
        printClass(academicClass,print);
